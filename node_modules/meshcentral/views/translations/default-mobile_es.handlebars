                            ...
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        ...
                                        <div style="margin-top:5px"><a href="#" onclick="return account_viewPreviousLogins()">Ver inicios de sesión anteriores</a></div>
                                    </div>
                                </div>
                                ...
                                <td class="areaFoot">
                                    <table style="width:100%">
                                        <tbody><tr>
                                            ...
                                            <td style="width:1%"><input id="id_p15consoleClear" type="button" class="bottombutton" value="Borrar" onclick="p15consoleClear()"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
