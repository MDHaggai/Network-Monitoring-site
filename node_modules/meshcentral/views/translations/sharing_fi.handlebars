    ...
    <div id="dialog" class="noselect" style="display:none">
        ...
        <div id="dialogBody">
            ...
            <div id="dialog7" style="">
                ...
                <div id="d7amtkvm">
                    <h4>Intel&amp;reg; AMT laitteisto KVM</h4>
                    <div>
    ...
    <script>
        ...
        */
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "Zip-tiedostonimi", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip -r', path: p13filetreelocation.join('/'), files: inputFiles });
