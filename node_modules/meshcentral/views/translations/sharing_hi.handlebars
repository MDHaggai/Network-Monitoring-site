    ...
    <script>
        ...
        */
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "ज़िप फ़ाइल नाम", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip -r', path: p13filetreelocation.join('/'), files: inputFiles });
